            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control disabled" readonly id="email" name="email" placeholder="Digite seu e-mail" value="<?= $userData->email ?>">
                    </div>
